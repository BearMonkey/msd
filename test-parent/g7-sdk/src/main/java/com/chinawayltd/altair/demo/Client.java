...
import com.chinawayltd.altair.demo.util.HttpPoolUtil;
...
public class Client {
    ...
    public static Response execute(Request request) throws Exception {
        ...
        switch (request.getMethod()) {
            ...
            case PUT_JSON:
                return HttpPoolUtil.httpPut(request.getHost(), request.getPath(),
                		request.getTimeout(), 
                		request.getHeaders(), 
                		request.getQueries(),
                		request.getJsonStrBody(),
                		request.getAccessId(), request.getSecretKey());
            case DELETE:
                return HttpPoolUtil.httpDelete(request.getHost(), request.getPath(),
                		request.getTimeout(), 
                		request.getHeaders(), 
                		request.getQueries(),
                		request.getAccessId(), request.getSecretKey());
